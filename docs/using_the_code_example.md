...
The following example clones the "[BTSTACK OTA](https://github.com/Infineon/mtb-example-psoc-edge-btstack-ota)" application with the desired name "BTStackOTA" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-btstack-ota --user-app-name BTStackOTA --target-dir "C:/mtb_projects"
   ```
